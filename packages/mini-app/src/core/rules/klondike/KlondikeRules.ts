import type { IColumn, IResultSlot, ITempBucket, ITempSlot, IDeck, IResultBucket } from "@/core/interfaces";
...
import { KlondikeTempBucketRules } from "./TempBucketRules";
import { KlondikeDealStrategy } from "./KlondikeDealStrategy";
...
export class KlondikeRules implements IGameRules {
    ...
    canMoveCard(
        ...
        if (targetSlot instanceof Column) {
            ...
            // В Косынке карты нельзя возвращать в колоду
            return false;
